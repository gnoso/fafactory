...
class FafactoryTest < Test::Unit::TestCase
  ...
  test "that creating a new instance works" do
    id = Fafactory.create_instance('test_app', :monkey, {"name" => "Mongo", "age" => 5, "gender" => "male"})["monkey"]["id"]
  ...
  test "that purging works" do
    10.times do
      Fafactory.create_instance('test_app', :monkey, {"name" => "Mongo", "age" => 5, "gender" => "male"})["monkey"]["id"]
    end
